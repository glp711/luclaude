      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="grid gap-4 md:grid-cols-2">
          ...
          >
            ...
            <p className="mt-1 text-sm text-ink-soft">{WHATSAPP_DISPLAY}</p>
          ...
          <a
            ...
            className="group rounded-2xl border border-cream-deep bg-cream-soft p-6 hover:border-coral hover:bg-coral-soft/30 transition"
          >
            <div className="h-12 w-12 rounded-full bg-sage-soft flex items-center justify-center mb-4 group-hover:bg-coral-soft transition text-xl" aria-hidden="true">
              📍
            </div>
            <h2 className="font-display text-2xl text-ink">Endereço</h2>
            <address className="mt-1 text-sm not-italic leading-relaxed text-ink-soft">
              {STORE_ADDRESS.full}
            </address>
            <span className="mt-4 inline-block text-xs text-coral-deep">Abrir no mapa →</span>
          </a>
        </div>
